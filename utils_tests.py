...
class TestProjectEuler(unittest.TestCase):
    ...
    def test_upper(self):
        subject = generate_pages("https://www.otodom.pl/sprzedaz/mieszkanie/lodz/?search%5Bregion_id%5D=5&search%5Bsubregion_id%5D=127&search%5Bcity_id%5D=1004&search%5Border%5D=created_at_first%3Adesc", 10)
